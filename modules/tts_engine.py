...
com pouca RAM, ideal pra hospedagem gratuita (Streamlit Cloud) ou local.
Repo: https://github.com/hexgrad/kokoro

IMPORTANTE: Kokoro NÃO clona a sua voz a partir de um áudio de referência.
Ele usa vozes pré-treinadas (mas naturais, não robóticas).
...
def synthesize(text: str, out_path: str, reference_voice_path: str | None = None,
    ...
    reference_voice_path: ignorado (mantido só por compatibilidade) — Kokoro
                           não clona voz a partir de áudio.
